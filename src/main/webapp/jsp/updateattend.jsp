  ...
  <div id="headerblank">
	...
	<div id="menublank">
	  ...
	  <form action="../editAttendence" method="post" >
	   ...
	   <br><br><br><br><br><br>
	 <h2 align="center"><font color="white">Update Attendence</font></h2>
	<table align="center" cellspacing="20" style="margin-top: 50px">
		...
		<tr>
			...
			<td><input style="background-color: #FAFAD2" type="text" name="date" id="date" value='<%=date%>'> &nbsp;&nbsp; <font color="white">(Enter the date dd-mm-yyy format)</font></td>
			<td><span id="date" style="color:red"></span></td>
		</tr>

		<tr>
			<td><font color="white">Select Attendence:</font></td>
			<!-- <td><select style="background-color: #FAFAD2" id="attendence" name="loginType">
			 ...
			 -->
			<td> <input type="radio" name="attended" value="A" checked="checked"><font color="white">Attended</font> &nbsp;&nbsp;
<input type="radio" name="notattended" value="NA"><font color="white">Not Attended</font>
			 </td>
			 <td><span id="attendence" style="color:red"></span></td>
		</tr>
