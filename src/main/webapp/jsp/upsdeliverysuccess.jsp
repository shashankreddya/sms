...
<link href="/sms/css/style1.css" rel="stylesheet"
	type="text/css" />
				...
				<div id="menublank">
					<div id="menu">
						<ul>
							...
							<li style="margin-right: 320px;"><a href="/sms/jsp/contactus.jsp" class="menu">Contact
									Us</a></li>
...
<form action="updatecontrol" method="post" name="deliverysuccess"  >
<br/><br/><br/><h1 style="color: white;" align="center"> booking id : <%=session.getAttribute("bookingid")%><br/><br/> Delivery Status Updated Successfully  </h1>
<div style="margin-left: 400px;margin-top: 30px;">
<input type="button" value="Update more" src="/sms/jsp/upsmain.jsp" onclick="window.location='/sms/jsp/upsmain.jsp';"/>
</div>
</form>
