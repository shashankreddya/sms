...
<div id="headerbg">
  <div id="headerblank">
	...
	<div id="menublank">
	 ...
	 <br><br><br><br><br><br>
	 <h2 align="center"><font color="white">Attendence</font></h2>
	 <div style="margin-top: 100px; margin-left: 200px;">
	 
	  <input type="button" value="Add Attendence" name="Add Attendence" value="Add Attendence" onclick="window.location='/sms/jsp/addattendence.jsp';" style="width: 200px;height: 100px;"/>
	  <input type="button" name="View Attendence" value="View Attendence" onclick="window.location='/sms/jsp/viewattendence.jsp';" style="width: 200px;height: 100px;"/>
  	  <input type="button" name="Edit Attendence" value="Edit Attendence" onclick="window.location='/sms/jsp/viewAttendence1.jsp';" style="width: 200px;height: 100px;"/>
